...
- Third-person narration ABOUT the user (HIGHEST-PRIORITY filter - overrides any "advice/evaluation" keep signal below). If the paragraph refers to the user in the THIRD person - by name or by "she/he/they/the user" - while restating their data, reasoning, OR giving judgement/advice about them ("She has ~600-700 kcal left, she should keep it lean", "Last Monday she had quinoa + chicken", "<Name> has consumed ~1463 kcal", "the user's protein is low so dinner should..."), it is the assistant reasoning to ITSELF, NOT a message to the user -> filter. The presence of evaluation/advice does NOT rescue it: third-person-about-the-user is internal EVEN WHEN it judges or advises. A real broadcast addresses the user directly (second person, or subject-dropped direct address like "还有577大卡" / "晚餐保持清淡"), never narrates the user in third person. Also still filter a flat machine-style log of figures with no interpretation ("Lunch had 524 kcal, target is 1265. Remaining ~741 kcal", "Based on the data: lunch had 759 cal"). Note: mere absence of an explicit "you" does NOT by itself make a paragraph internal - a subject-dropped sentence in direct address that judges/advises ("占了全天一半，脂肪用掉一半", "蛋白质太低，晚餐压力大") is user-facing -> KEEP; only THIRD-PERSON-about-user or pure log tone filters here. **VOCATIVE EXCEPTION**: a paragraph that OPENS with the user's name followed by a comma/pause and then addresses them ("施沛威，今天 2705 大卡…" / "诗怡，脂肪超了…" / "<Name>, you're at 2705 today…") is a DIRECT ADDRESS (呼语), NOT third-person narration — the name is being used to call the user's attention, not to talk about them. Distinguish: name-as-vocative (opening/salutation followed by ", ..." then advice/data spoken to the user) = KEEP; name-as-subject ("<Name> has consumed 1463 kcal", "<Name>'s protein is low") = filter. **SECOND-PERSON EXCEPTION**: any paragraph containing an explicit second-person pronoun ("你" / "你的" / "you" / "your") addressing the user, even when it also restates their data ("你从开始减脂以来体重是有在降的（105.8→104），这周涨的0.4斤完全在经期波动范围内", "你今天已经吃了 1633 kcal") = KEEP. Restating a user's own data back to them with "你..." is a valid direct message, not third-person analysis. The third-person filter applies only when the user is referenced in the THIRD person (he/she/they/the user/by-name-as-subject); "你" / "you" as subject is BY DEFINITION second person and cannot be third-person narration.
