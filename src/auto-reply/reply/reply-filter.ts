...
- Bare third-person data restatement that recites numbers/arithmetic with NO judgement and is clearly NOT addressed to the user - EITHER it names the user in third person ("<Name> has consumed ~1463 kcal", "the user's lunch was 524 cal") OR it is a flat machine-style log of figures with no interpretation ("Lunch had 524 kcal, target is 1265. Remaining ~741 kcal", "Based on the data: lunch had 759 cal"). IMPORTANT: this filter fires ONLY when there is no evaluation/advice AND (third-person naming of the user OR pure log tone). The mere absence of an explicit "you" is NOT enough - a subject-dropped sentence that judges or advises ("占了全天一半，脂肪用掉一半", "蛋白质太低，晚餐压力大") is user-facing advice -> KEEP, not this.
